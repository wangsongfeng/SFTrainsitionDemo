...
- (void)initUI{
    ...
    UIView *image = [[UIView alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2-(SCREEN_WIDTH/3-20)/2, SCREEN_HIGHT/2-64-70, SCREEN_WIDTH/3-20, (SCREEN_WIDTH/3-20)*1.3)];
